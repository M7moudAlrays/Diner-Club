<div class="main-header sticky side-header nav nav-item">
    <div class="container-fluid">
        ...
        <div class="main-header-right">
            <ul class="nav">
                <li class="">
                <a  href="{{route('homePage.index')}}" class="btn btn-info">
                    Website
                </a>
                            ...
                            <div class="menu-header-content bg-primary text-right">
                                <div class="d-flex">
                                    ...
                                    <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                            href="\MarkAsRead_all">  select All as Read</a></span>
                                </div>
                                <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
                                <h6 style="color: #ffff00;text-align:left" id="notifications_count">
                                notification not read:  {{auth()->user()->unreadNotifications->count() }}
                            ...
                            <div id="unreadNotifications">
                                @foreach (auth()->user()->unreadNotifications as $notification)
                                    <div class="main-notification-list Notification-scroll">
                                        <a class="d-flex p-3 border-bottom"href="{{ route('reservations.index') }}">
