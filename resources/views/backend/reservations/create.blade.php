            ...
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    ...
                    <div class="">
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6" id="fnWrapper">
                                ...
                                <input class="form-control fc-datepicker" name="attendance_date" placeholder="YYYY-MM-DD"
                            ...
                            <div class="parsley-input col-md-6" id="fnWrapper">
                                ...
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" name="attendance_time" required="" type="time">
                            </div>
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6" id="fnWrapper">
                                ...
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" name="table_number" required="" type="number">
                            </div>

                            <div class="parsley-input col-md-6" id="fnWrapper">
                                <label>guests_number: <span class="tx-danger">*</span></label>
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" name="guests_number" required="" type="number">
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                        <button class="btn btn-main-primary pd-x-20 mb-5" type="submit">confirm</button>
                    </div>
                </form>
            </div>
        </div>
